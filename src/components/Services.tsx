  ...
  const services = [
    {
      ...
      description:
        "End-to-end web applications from database to interface, built for scale and maintainability.",
...

    {
      ...
      title: "Web Solutions",
      description:
        "Custom sites and web apps aligned with your brand, audience, and business goals.",
      features: [
        "Responsive Design",
        "SEO Optimization",
        "Performance Tuning",
    ...
    },
    {
      ...
      description:
        "Complete online stores with payments, inventory, and analytics for growth.",
      features: [
        "Online Store Setup",
        "Payment Gateway",
        "Inventory System",
      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="mb-6">
                <div className="w-16 h-16 rounded-full bg-[#3b82f6] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
